...
public class DocuportConstants {
    ...
    public static final String CURRENT_LOGIN_URL = "https://beta.docuport.app/login?redirect=%2F";
    public static final String CURRENT_LOGOUT_URL = "https://beta.docuport.app/login";
    ...
    public static final String ERROR_MESSAGE_FOR_EMPTY_LOGIN = "Please enter your username or email address";
